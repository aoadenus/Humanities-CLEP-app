    ...
    <div className="space-y-6">
      <Card className="surface-tint p-6 md:p-8">
        ...
        <p className="mt-4 text-[18px] leading-8 text-[var(--text-secondary)]">
          Read this chunk like a slide. Use the sidebar or bottom bar to move through the section.
        </p>
      </Card>
          ...
          if (block.type === "heading") {
            return (
              <Card key={`${block.type}-${index}`} className="p-6">
                <h2 className="font-reading text-3xl font-bold text-[var(--text-primary)]">📖 {block.text}</h2>
              </Card>
            );
          }
